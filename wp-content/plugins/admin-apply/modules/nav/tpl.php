	<h3 class="m-b"><span><?php esc_html_e('Bar'); ?></span></h3>
	<p class="no-m-t text-sm"><?php esc_html_e('Change the admin bar on the top'); ?></p>
	<p>
		<label>
			...
			<?php esc_html_e('Apply style on front-end '); ?>
		</label>
	</p>
	<div class="box">
		<h4><span><?php esc_html_e('Logo &amp; name'); ?></span></h4>
		<div class="box-body b-t hide">
			<p>
				<label>
					<?php esc_html_e('logo image'); ?>
					<br>
					<input name="<?php esc_attr_e($this->setting->setting_name); ?>[bar_logo]" type="text" value="<?php esc_html_e( $this->setting->get_setting('bar_logo') ); ?>">
			...
			<p>
				<label>
					<?php esc_html_e('Link'); ?>
					<input name="<?php esc_attr_e($this->setting->setting_name); ?>[bar_name_link]" type="text" value="<?php esc_html_e( $this->setting->get_setting('bar_name_link') ); ?>" class="widefat">
				</label> 
			</p>
			<p>
				<label>
					<?php esc_html_e('Name'); ?>
					<input name="<?php esc_attr_e($this->setting->setting_name); ?>[bar_name]" type="text" value="<?php esc_html_e( $this->setting->get_setting('bar_name') ); ?>" class="widefat">
				</label> 
			</p>
			<p>
				<label>
					...
					<?php esc_html_e('Hide "Name"'); ?>
				</label>
			</p>
		</div>
	</div>
	<div class="box">
		<h4><span><?php esc_html_e('Quick links'); ?></span></h4>
		<div class="box-body b-t hide">
			<p>
				<fieldset>
					<label>
					...
					<label>
						...
						<?php esc_html_e('Remove "Comments"'); ?>
					</label>
					<br>
					<label>
					...
					<label>
						...
						<?php esc_html_e('Remove "My sites"'); ?>
					</label>
					<?php } ?>
				</fieldset>
			</p>
	...
	<h3 class="m-b"><span><?php esc_html_e('Menu'); ?></span></h3>
	<p class="no-m-t  text-sm"><?php esc_html_e('Change the menu on the left.'); ?></p>
	<p class="text-sm">
		<label>
		...
		<label>
			...
			<?php esc_html_e('Hide collapse link'); ?>
		</label> &nbsp;
		<label>
	...
	<div class="clearfix admin-menus">
			...
			<div class="box bg admin-menu-item">
				...
				<div class="box-body b-t hide">
					<input name="<?php esc_attr_e( $this->setting->setting_name.'[menu]['.$id[0].'][index]' ); ?>" value="<?php esc_html_e( $index ); ?>" type="text" hidden>
					<?php if($id[1]){ ?>
					<p>
						<label>
							<?php esc_html_e('Title:'); ?>
							<input name="<?php esc_attr_e( $this->setting->setting_name.'[menu]['.$id[0].'][title]' ); ?>" value="<?php esc_html_e( $title ); ?>" type="text" class="widefat">
						</label>
					</p>
					<?php } ?>
					<p>
						<label>
							...
							<?php esc_html_e('Remove from menu'); ?>
						</label>
					</p>
					<?php
					...
					?>
					<p class="toggle">
						<a href="#admin" class="c-p"><?php esc_html_e('Submenu'); ?></a>										
					</p>
					<?php } ?>
						...
						<div class="box admin-menu-item">
							...
							<div class="box-body b-t hide">
								...
								<p>
									<label>
										<?php esc_html_e('Title:'); ?>
										<input name="<?php esc_attr_e( $this->setting->setting_name.'[submenu]['.$sid[0].'][title]' ); ?>" value="<?php esc_html_e( $title ); ?>" type="text" class="widefat">
									</label>
								</p>
								<p>
									<label>
			...
			<div id="dropdown" class="dropdown box">
				<div class="box-body" id="tab-iconlist">
					<div class="clearfix">
						<ul class="subsubsub">
							<li><a href="#tab-dashicons" class="current"><?php esc_html_e('Dashicons'); ?></a> | </li>
							<li><a href="#tab-icons"><?php esc_html_e('Icons'); ?></a></li>
						</ul>
					</div>
