	...
	'sections'     => array(
		...
		array(
			...
			'fields'         => array(
                ...
                array(
                    'settings' => 'header_started_btn',
                    'label'    => esc_html__( 'Header Get Started', 'edumax-core' ),
                    'type'     => 'switch',
                    'priority' => 10,
                    'default'  => true
                ),
        ...
        array(
            ...
            'fields'         => array(
                ...
                array(
                    ...
                    'label'    => esc_html__( 'Course Sorting Bar', 'edumax-core' ),
                    'type'     => 'switch',
                    'priority' => 10,
                    'default'  => true
                ),
                array(
                    ...
                    'label'    => esc_html__( 'Course Count', 'edumax-core' ),
                    'type'     => 'switch',
                    'priority' => 10,
                    'default'  => true
                ),
				...
				array(
					...
					'label'    => esc_html__( 'Level Filter', 'edumax-core' ),
					'type'     => 'switch',
					'priority' => 10,
					'default'  => true
				),
				array(
                    ...
                    'label'    => esc_html__( 'Category Filter', 'edumax-core' ),
                    'type'     => 'switch',
					'priority' => 10,
					'default'  => true
				),
				array(
                    'settings' => 'topics_filter',
                    'label'    => esc_html__( 'Topic Filter', 'edumax-core' ),
                    'type'     => 'switch',
                    'priority' => 10,
                    'default'  => true
				),
				array(
                    'settings' => 'single_course_content_reverse',
                    'label'    => esc_html__( 'Single Course Reverse', 'edumax-core' ),
                    'type'     => 'switch',
                    'priority' => 10,
                    'default'  => false
				),
        ...
        array(
            ...
            'fields'         => array(
				...
				array(
					...
					'label'    => esc_html__( 'Login Text Color', 'edumax-core' ),
					'type'     => 'rgba',
					'priority' => 10,
					'default'  => '#1f2949',
				),
				array(
					...
					'label'    => esc_html__( 'Login bg Color', 'edumax-core' ),
					'type'     => 'rgba',
					'priority' => 10,
					'default'  => '#ffffff',
				),
				array(
					'settings' => 'login_reg_screen_btn_color',
					'label'    => esc_html__( 'Login btn bg color', 'edumax-core' ),
					'type'     => 'rgba',
					'priority' => 10,
					'default'  => '#1f2949',
				),
				array(
					'settings' => 'login_reg_screen_btn_hover',
					'label'    => esc_html__( 'Login btn bg hover', 'edumax-core' ),
					'type'     => 'rgba',
					'priority' => 10,
					'default'  => '#1f2949',
				),
				array(
					'settings' => 'login_reg_screen_btn_text_color',
					'label'    => esc_html__( 'Login btn text color', 'edumax-core' ),
					'type'     => 'rgba',
					'priority' => 10,
					'default'  => '#1f2949',
				),
				array(
					'settings' => 'login_reg_screen_btn_text_hover_color',
					'label'    => esc_html__( 'Login btn text hover', 'edumax-core' ),
					'type'     => 'rgba',
					'priority' => 10,
					'default'  => '#1f2949',
				),
