                ...
                <div class="col common-menu d-none d-lg-block order-lg-7">
                    ...
                    <?php
                        ...
                        <?php if( class_exists( 'Easy_Digital_Downloads' ) ) {?>
                            <div class="col-auto order-lg-7 order-3">
                                <ul id="site-header-cart" class="site-header-cart menu site-header-cars-edd">
                                    <li class="cart-icon">
                                        <a class="cart-content-edd cart-contents" href="<?php echo edd_get_checkout_uri(); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'edumax' ); ?>">
                                            <span class="count edd-cart-quantity"><?php echo edd_get_cart_quantity();?></span>
                                        </a>
                                    </li>
                                    <li>
                    ...
                    <?php
                        ...
                        $header_started_btn = get_theme_mod('header_started_btn', true);
