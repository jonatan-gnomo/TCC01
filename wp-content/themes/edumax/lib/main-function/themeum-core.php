...
if(!function_exists('edumax_css_generator')){
    function edumax_css_generator(){
        ...
        if ( get_theme_mod( 'header_fixed', true ) ){
            $output .= '.site-header.sticky{ position:fixed;top:0;left:auto; z-index:99999;margin:0 auto; width:100%;-webkit-animation: fadeInDown 400ms;animation: fadeInDown 400ms;}';
        ...
        if ( get_theme_mod( 'header_transparent', false ) ){
            $output .= '.site-header.sticky{ background-color: transparent; }';
        }
        ...
        if($login_reg_screen_bg_color) {
            $output .= '
                ...
                .edumax-signin-popup-body .edumax-signin-modal-form {
                    border-right: 1px solid ' . esc_attr($login_reg_screen_bg_color) . ';
                }
                .edumax-signin-modal-right {
                    border-left: 1px solid ' . esc_attr($login_reg_screen_bg_color) . ';
                }
            ';
        }
        if($login_reg_screen_text_color) {
            $output .= '
                ...
                .edumax-login-remember {
                    color : ' . $login_reg_screen_text_color . ';
                }
            ';
        }
        $login_reg_screen_btn_color = get_theme_mod( 'login_reg_screen_btn_color', '#008cc9' );
        $login_reg_screen_btn_hover = get_theme_mod( 'login_reg_screen_btn_hover', '#006fa0' );
        if($login_reg_screen_btn_color) {
            $output .= '
                .edumax-signin-modal-form button[type="submit"] {
                    background-color: ' . $login_reg_screen_btn_color . ';
                    border: 1px solid ' . $login_reg_screen_btn_color . ';
                }
            ';
        }
        if($login_reg_screen_btn_hover) {
            $output .= '
                .edumax-signin-modal-form button[type="submit"]:hover {
                    background-color: ' . $login_reg_screen_btn_hover . ';
                    border: 1px solid ' . $login_reg_screen_btn_hover . ';
                }
            ';
        }
        $login_reg_screen_btn_text_color = get_theme_mod('login_reg_screen_btn_text_color', '#fff');
        if($login_reg_screen_btn_text_color) {
            $output .= '
                .edumax-signin-modal-form button[type="submit"] {
                    color: ' . $login_reg_screen_btn_text_color . ';
                }
            ';
        }
        $login_reg_screen_btn_text_hover_color = get_theme_mod('login_reg_screen_btn_text_hover_color', '#fff');
        if($login_reg_screen_btn_text_hover_color) {
            $output .= '
                .edumax-signin-modal-form button[type="submit"]:hover {
                    color: ' . $login_reg_screen_btn_text_hover_color . ';
                }
            ';            
        }
        ...
        // sub header
        $output .= '.subtitle-cover h2.page-leading{font-size:'.get_theme_mod( 'sub_header_title_size', '49' ).'px;color:'.get_theme_mod( 'sub_header_title_color', '#ffffff' ).';}';
