    ...
    function edumax_plugins_include()
    {
        $plugins = array(
            ...
            array(
                ...
                'slug'                  => 'edumax-core',
                'source'                => get_template_directory_uri().'/lib/plugins/edumax-core.zip',
                'required'              => true,
                'version'               => '2.0.5',
                'force_activation'      => false,
                'force_deactivation'    => false,
            ...
            array(
                ...
                'source'                => get_template_directory_uri().'/lib/plugins/edumax-demo-importer.zip',
                'required'              => false,
                'version'               => '',
                'force_activation'      => false,
                'force_deactivation'    => false,
